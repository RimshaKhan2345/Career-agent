...
def get_career_roadmap(field: str) -> str:
    maps = {
        ...
        "full stack developer": "Learn front-end (HTML, CSS, JavaScript) and back-end (Node.js, databases) development, Git, and projects.",
        "ai engineer": "Learn AI concepts, machine learning, Deep learning, Python, Transformers, PyTorch, and AI tools."
    }
